...
def verify_all_threads_closed(allowable_threads: Optional[List[str]] = None):
    ...
    Credit for this functions code goes to the OpenVisionCapsules project,
    specifically:
    https://github.com/opencv/open_vision_capsules/blob/master/vcap/vcap/testing/thread_validation.py
    """
